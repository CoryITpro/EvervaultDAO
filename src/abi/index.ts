...
export { abi as LootTokenContract } from "./tokens/Loot.json";
export { abi as EveTokenContract } from "./tokens/Eve.json";
export { abi as BUSDTokenContract } from "./tokens/BUSD.json";
...
export { abi as DaoContract } from "./dao.json";
